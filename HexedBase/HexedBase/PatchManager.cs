...
namespace HexedBase
{
    internal class PatchManager
    {
        ...
        private static void OnPlayerJoin(Player player)
        {
            ...
            Console.WriteLine("Player Joined: " + player.field_Private_APIUser_0.displayName);
        }
        ...
        {
            if (player == null) return;
            Console.WriteLine("Player Left: " + player.field_Private_APIUser_0.displayName);
        }
        ...
        private static void OnCloseQM(IntPtr instance)
        {
            ...
            Console.WriteLine("QuickMenu Closed!");
        ...
        private static void OnOpenQM(IntPtr instance)
        {
            ...
            Console.WriteLine("QuickMenu Opened!");
