...
public class MMCarousel : WorldPage {
        ...
        string toolTip2, Sprite sprite1 = null, Sprite sprite2 = null) 
    {
        ...
        LogOutBtn.GetComponent<VRC.UI.Elements.Tooltips.UiTooltip>().Method_Public_Void_String_0(toolTip1);
        ...
        ExitBtn.GetComponent<VRC.UI.Elements.Tooltips.UiTooltip>().Method_Public_Void_String_0(toolTip2);
