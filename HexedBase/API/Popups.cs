    ...
    internal class StarbornPopups
    {
        ...
        public static void InputPopup(string Title, Action<string> EndString, Action<string> RealTimeString = null, Action OnClose = null, KeyBoardType keyBoardType = KeyBoardType.Standard, string Placeholder = "Enter Text", string OkButton = "OK", string CancelButton = "Cancel", bool MultiLine = true, int CharLimit = 0, bool KeepOpen = false, bool ReadOnly = false)
        {
            ...
            try
            {
                ...
                KeyboardData keyboardData2 = keyboardData.Method_Public_KeyboardData_String_String_String_String_String_0(Title, Placeholder, "", OkButton, CancelButton);
        ...
        public static void HudMessage(string Text, Sprite icon = null)
        {
            ...
            activeCarousel.Method_Private_Void_LocalizableString_Sprite_0(LocalizableString.Method_Public_Static_LocalizableString_String_PDM_0(Text), icon);
        }

        public static void HudToast(string content, string description = null, Sprite icon = null, float duration = 5f)
        {
            LocalizableString message = LocalizableString.Method_Public_Static_LocalizableString_String_PDM_0(content);
            LocalizableString desc = LocalizableString.Method_Public_Static_LocalizableString_String_PDM_0(description);

            VRCUiManager.field_Private_Static_VRCUiManager_0.field_Private_MonoBehaviourPublicObnoObmousCaObhuGaCaUnique_0.notification.Method_Public_Void_Sprite_LocalizableString_LocalizableString_Single_Object1PublicTYBoTYUnique_1_Boolean_0(icon, message, desc, duration);
        }
